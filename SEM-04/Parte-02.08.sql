...
--Habilito la inserción a campo IDENTITY
SET IDENTITY_INSERT UnidadUso ON 

--Inserción de Unidades de Uso
...
go
insert into UnidadUso(idunidaduso,descripcion,categoria,idficha)
values (999,'VIVIENDA 3ER PISO','DOM',333)
go
insert into UnidadUso(idunidaduso,descripcion,categoria,idficha)
values (1000,'COMERCIAL 1ER PISO','COM',334)
go

--Deshabilito la inserción a campo IDENTITY
SET IDENTITY_INSERT UnidadUso ON

--Crear una tabla temporal para IDS del Excel
create table #IDS
(
id integer
)

--Inserto los IDS del Excel
insert into #IDS
values
(1),
(2),
...
--Obtengo los idunidaduso que están en la tabla #IDS mas no en UnidadUso
select i.id,u.idunidaduso from #IDS i
left join UnidadUso u on i.id=u.idunidaduso
